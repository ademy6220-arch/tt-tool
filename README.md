# tt-tool import requests,re,time
...
if fl==1:
    ...
    report_id=3021
print("---------------------------------------------------------")
print('By t.me/aquastocks -- TikTok @aqa')
print("---------------------------------------------------------")
...
while True:
    ...
    if '"statusCode":0,"errMsg":"Thank you for your feedback"' in req.text:
        print(f'\r[{Fore.MAGENTA}${Fore.RESET}] {Fore.GREEN}Done Report [{done}]{Fore.RESET} | {Fore.RED}Error Report [{error}]{Fore.RESET} | {Fore.CYAN}Target: [{target}] Sleep [{sleep}] userID [{ID}]{Fore.RESET}',end='')
        done+=1
    elif 'Sorry, the server is currently unavailable. Please try again' in req.text:
        print(f'\r[{Fore.MAGENTA}${Fore.RESET}] {Fore.GREEN}Done Report [{done}]{Fore.RESET} | {Fore.RED}Error Report [{error}]{Fore.RESET} | {Fore.CYAN}Target: [{target}] Sleep [{sleep}] userID [{ID}]{Fore.RESET}',end='')
        error+=1
    else:
        print(f'\n\t[{Fore.RED}!] Error{Fore.RESET} sending report',req.text)
        exit("[!] t.me/aquastocks")
